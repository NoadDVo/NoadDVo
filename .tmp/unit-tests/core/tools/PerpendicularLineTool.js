...
exports.perpendicularLineTool = exports.PerpendicularLineTool = void 0;
...
class PerpendicularLineTool extends BaseTool_1.BaseTool {
    anchorPoint = null;
    constructor() {
        super({
            cursor: "crosshair",
    ...
    createLine(anchorPoint, sourceLine, context) {
        ...
        const line = (0, ConstructionToolUtils_1.createConstructionLine)(anchorPoint, helperPoint, "Perpendicular Line");
...
exports.PerpendicularLineTool = PerpendicularLineTool;
exports.perpendicularLineTool = new PerpendicularLineTool();
