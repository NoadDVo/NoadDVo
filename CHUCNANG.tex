...
\titleformat{\subsection}
  ...
  {\textcolor{primary}{\faAngleDoubleRight\ \thesubsection}}
  {0.5em}
  {}
...
\begin{itemize}[label=\textcolor{primary}{\faGripLines}]
    ...
    \item \textbf{Perpendicular Bisector (Đường trung trực):}
    \begin{itemize}
    ...
    \item \textbf{Angle Bisector (Đường phân giác):}
    \begin{itemize}
...
\begin{itemize}[label=\textcolor{primary}{\faDrawPolygon}]
    \item \textbf{Circle (Đường tròn Tâm - Điểm):}
    \begin{itemize}
    ...
    \item \textbf{Compass (Đường tròn Bán kính đoạn thẳng):}
    \begin{itemize}
    ...
    \item \textbf{Circumcircle (Đường tròn ngoại tiếp):}
    \begin{itemize}
    ...
    \item \textbf{Incircle (Đường tròn nội tiếp):}
    \begin{itemize}
...
\begin{itemize}[label=\textcolor{primary}{\faWaveSquare}]
    ...
    \item \textbf{Polynomial (Đồ thị Hàm đa thức):}
    \begin{itemize}
...
\begin{itemize}[label=\textcolor{primary}{\faSync}]
    \item \textbf{Reflect Line (Đối xứng trục):}
    \begin{itemize}
    ...
    \item \textbf{Reflect Point (Đối xứng tâm):}
    \begin{itemize}
...
\begin{itemize}[label=\textcolor{primary}{\faDraftingCompass}]
    ...
    \item \textbf{Distance / Length (Đo khoảng cách):}
    \begin{itemize}
    ...
    \item \textbf{Trim (Cắt đoạn dư thừa):}
    \begin{itemize}
